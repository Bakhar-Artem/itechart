package test.by.bakhar.task2.sax;

import by.bakhar.task2.builder.BankBuilder;
import by.bakhar.task2.builder.SaxBankBuilder;
...
public class SaxBankBuilderTest {
    ...
    public void testBuildBanks() throws BankException {
        BankBuilder saxBankBuilder = new SaxBankBuilder();
        saxBankBuilder.buildBanks("src\\main\\resources\\test\\bank.xml");
        Set<Bank> actual = saxBankBuilder.getBanks();
    ...
    public void testBankException() throws BankException {
        BankBuilder saxBankBuilder = new SaxBankBuilder();
        saxBankBuilder.buildBanks("src\\main\\resources\\test\\exception.xml");
    }
}